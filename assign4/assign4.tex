...
\date{Thursday, 9 October, 2014} % Insert date here if you want it to appear below your name
...
\end{verbatim}
    ...
    \textbf{SOLUTION}
    In order to get all the links from 100 URIs, I used a python script.  BeautifulSoup was used to extract all the links and ensure they were valid links (returned a 200 when followed.  Additionally in order to try to make sure I had a good spread, I used grep to extract all the nytimes.com and add them to the front of the list. ``egrep nytimes.com uniqueURIs > uris'' then ``cat uniqueURIs > uris''


\lstinputlisting[breaklines=true, caption=downloadLinks.py]{"prob1/downloadLinks.py"}

\textbf{Downloads all the links from 100 URIS:} 
...
\begin{verbatim}
In order to solve this problem, I used a python script to make a graphViz file that gephi will read as input.  Since the output file has 9862 linkes, I uploaded it on github as graph.gv.
\end{verbatim}


\lstinputlisting[breaklines=true, caption=makeGraphViz.py]{prob2/makeGraphViz.py}
...
\end{verbatim}
\textbf{graph.pdf}
\includegraphics[scale=0.75]{prob3/graph.pdf}

\textbf{HITS Metrics}
\includegraphics[scale=0.6]{prob3/HITS/authorities.png}\newline
\includegraphics[scale=0.6]{prob3/HITS/hubs.png}\newline

\textbf{PageRank}
\includegraphics[scale=0.6]{prob3/PageRank/pageranks.png}


\textbf{Avg Degree: 1.553}
\includegraphics[scale=0.6]{prob3/DegreeReport/degree-distribution.png}\newline
\includegraphics[scale=0.6]{prob3/DegreeReport/indegree-distribution.png}\newline
\includegraphics[scale=0.6]{prob3/DegreeReport/outdegree-distribution.png}\newline
...
\includegraphics[scale=0.6]{prob3/NetworkDiameter/Betweenness-Centrality-Distribution.png}\newline
\includegraphics[scale=0.6]{prob3/NetworkDiameter/Closeness-Centrality-Distribution.png}\newline
\includegraphics[scale=0.6]{prob3/NetworkDiameter/Eccentricity-Distribution.png}\newline


\textbf{Connected Components}\newline
Number of Weakly Connected Components: 19\newline
Number of Stronlgy Connected Components: 2052\newline
\includegraphics[scale=0.6]{prob3/ConnectedComponents/cc-size-distribution.png}\newline
...
\bibitem{lamport94}\url{https://gephi.github.io/}
