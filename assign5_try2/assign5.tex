...
\date{Thursday, 16 October, 2014} % Insert date here if you want it to appear below your name
...
\textbf{SOLUTION}
\begin{verbatim}
In order to solve this, I used Twython's get_friends_list() to retrieve 
the friend list and extract the number of friends for each.  


\end{verbatim}
\lstinputlisting[breaklines=true, caption=twitterFriendCounter.py]{twitterFriendCounter.py}

\clearpage
\begin{verbatim}


Below is the plot for the extracted data.  The graph below is a 
representation of  the number of friends (y-axis) and the friends 
sorted by number of friends (x-axis).
...
\includegraphics[scale=.75]{rplot.pdf}

\begin{verbatim}

As shown by the graph, the "friendship paradox" that says your friends have more friends than you, is true for my twitter account.
...
\bibitem{lamport94}\url{http://stackoverflow.com/questions/3453695/adding-text-to-a-plot}
\bibitem{lamport94}\url{http://www.r-bloggers.com/adding-a-legend-to-a-plot/}
\bibitem{lamport94}\url{http://twython.readthedocs.org/en/latest/}
\bibitem{lamport94}\url{http://www.craigaddyman.com/mining-all-tweets-with-python/}
\bibitem{lamport94}\url{https://docs.python.org/2/library/collections.html#ordereddict-examples-and-recipes}
